		...
		<section>
            ...
            <Col md="5" className='mb-3'>
              <div className="form-heading mb-3">
                ...
                <span className='text-secondary'>for any question just contact us</span>
              </div>
              <Form>
                ...
                <Form.Group className="mb-3" controlId="message">
                  ...
                  <Form.Control as="textarea" rows={7} placeholder="Your Massage"/>
                </Form.Group>
                <Button 
								    width={"150px"}
					          height={"45px"}
					          color={"#fff"}
					          bg={"#2F3988"}
					          border={"none"} className='btn-info my-3'>Send message</Button>
              </Form>
            </Col>
